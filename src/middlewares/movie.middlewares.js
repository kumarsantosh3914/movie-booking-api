...
const validateMovieCreateRequest = async (req, res, next) => {
    ...
    // validate the movie descritpion
    if (!req.body.description) {
        badRequestResponse.err = 'The description of the movie is not presnet in the request';
        return res.status(STATUS.BAD_REQUEST).json(badRequestResponse);
    }
    ...
    // validate the release data of the movie
    if (!req.body.releaseData) {
